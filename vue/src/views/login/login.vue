      ...
      <div class="login-box clearfix"style="margin-top:10px">
        <div class="fr form-box">
          ...
          <form id="jsLoginForm" autocomplete="off">
            ...
            <div class="form-group marb8" v-if="!forgetPassword">
              <label>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</label>
            ...
            <div class="clearfix" v-if="forgetPassword">
              <div class="form-group marb8 verify-code">
                  <label>短信验证码</label>
                  <input id="jsPhoneRegCaptcha" v-model="parseWord" type="text" placeholder="输入手机验证码">
              </div>
          ...
          <p class="form-f">
            忘记密码？
            <a @click="forgetPasswordMethod" >[使用验证码登录吧!]</a>
          </p>
        </div>
...
<style  scoped>
  ...
  .bg-box{
    background:url(../../static/images/login/loginBg.jpeg) no-repeat center center;
  }
  .login-box{
    width:853px;
    height: 482px;
