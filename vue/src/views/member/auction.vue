                    ...
                    <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
                        ...
                        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                            <tbody>
                                ...
                                <tr>
                                    <td align="right" bgcolor="#ffffff">起拍价格</td>
                                    <td align="left" bgcolor="#ffffff">
                                ...
                                <tr>
                                    <td align="right" bgcolor="#ffffff">一口价：</td>
                                    <td align="left" bgcolor="#ffffff">
                                        <input name="mobile" type="text" class="inputBg" id="mobile_0" v-model="cbooksEmpty.buyoutprice">
                                        <span :class = "{error:cbooksEmpty.buyoutprice==''}">(必填)</span></td>
                                </tr>
                                <tr>
